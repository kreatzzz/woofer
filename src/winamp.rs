...
/// The text with the gap it scrolls through, for drawing a non-bitmap
/// fallback line while keeping Winamp's looping marquee rhythm.
...
mod tests {
    ...
    fn a_short_title_sits_still_and_a_long_one_scrolls() {
        ...
        assert_eq!(state.marquee("Woofer", start).0, "Woofer");
