...
fn face_score(family: &str, weight: f32, han: &str, hint: &str) -> u32 {
    ...
    // Symbol faces often call themselves simply Symbols rather than Sans;
    // keep them eligible for stars, arrows, and music marks.
    if !family.contains("sans") && hint != "symbol" {
        score += 50;
    }
